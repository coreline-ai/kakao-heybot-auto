...
object HeybotSkillCatalog {
    ...
    val skills: List<HeybotSkillDefinition> = listOf(
        ...
        skill(
            ...
            listOf(
                "같은 방에서 이미지 전송 또는 답장 후 헤이봇 이미지 분석",
                "분석 직후 가방은 무슨 색이야?",
                "헤이봇 그 이미지에서 가방은 무슨 색이야?"
            ),
            "같은 방의 최근 이미지 또는 답장한 이미지를 설명하고, 관련 질문을 이어갈 수 있어요.",
    ...
    fun userHelpMessages(): List<String> = listOf(
        ...
        "헤이봇 사용법 2/5\n\n" +
            "[이미지]\n• 헤이봇 이미지 <설명>\n• 헤이봇 이미지 상태 / 취소 / 재전송\n" +
            "• 헤이봇 이미지 분석 / 이미지 글자 추출 / 이미지 글자 번역\n" +
            "  같은 방 최근 30분 이미지(다른 사람 포함)를 분석해요. 특정 이미지는 답장하세요.\n" +
            "• 분석 결과 뒤 관련 질문 또는 헤이봇 그 이미지에서 <질문>\n" +
            "  분석자 30분, 참여자 5분 동안 이어갈 수 있어요.\n\n" +
            "[영상]\n• 헤이봇 영상 <설명>\n• 헤이봇 영상 상태 / 취소 / 재전송\n\n" +
