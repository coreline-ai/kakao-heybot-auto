...
object HeybotSkillCatalog {
    ...
    val skills: List<HeybotSkillDefinition> = listOf(
        ...
        skill(
            ...
            "단일 YouTube 영상을 MP4로 받아 같은 방에 전송해요. 이 방의 유튜브 권한이 필요해요.",
    ...
    fun userHelpMessages(): List<String> = listOf(
        ...
        "헤이봇 사용법 4/5\n\n" +
            ...
            "단일 공개 YouTube 영상만 경량 MP4로 전송해요. 길수록 자동으로 화질·용량을 낮춰요. 전송 미확인 시 자동 재전송하지 않으며 재전송 명령으로만 다시 시도해요. 재생목록·로그인·DRM 영상은 지원하지 않으며, 이 방의 유튜브 권한이 필요해요.",
        "헤이봇 사용법 5/5\n\n" +
            "[음성 작업 관리]\n" +
            "• 헤이봇 음성 상태 / 헤이봇 음성 취소\n" +
